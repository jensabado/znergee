...
function toggleMode(mode) {
    $('#body').toggleClass('light-mode', mode === 'light');
    $('#body').toggleClass('dark-mode', mode === 'dark');

    $('#navbar').toggleClass('navbar-light', mode === 'light');
    $('#navbar').toggleClass('navbar-dark', mode === 'dark');

    $('#sidebar').toggleClass('sidebar-light-primary', mode === 'light');
    $('#sidebar').toggleClass('sidebar-dark-primary', mode === 'dark');

    $('#control-sidebar').toggleClass('control-sidebar-light', mode === 'light');
    $('#control-sidebar').toggleClass('control-sidebar-dark', mode === 'dark');

    // Toggle visibility of mode buttons
    $('#dark_mode_li').toggleClass('d-none', mode === 'dark');
    $('#light_mode_li').toggleClass('d-none', mode === 'light');
}

$('#dark_mode_btn').on('click', function(e) {
    e.preventDefault();
    toggleMode('dark');
});

$('#light_mode_btn').on('click', function(e) {
    e.preventDefault();
    toggleMode('light');
});
